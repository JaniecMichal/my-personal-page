...
export const ActiveNavbarLink = ({ href, title, icon, ariaLabel, exact = true }: ActiveNavbarLinkProps) => {
  const pathname = usePathname()
  const isActive = exact || (!exact && href === "/") ? pathname === href : pathname.startsWith(href)
